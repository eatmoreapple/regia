...
func (n *routerNode) insertChild(numParams uint8, path, fullPath string, handle HandleFuncGroup) {
...
// given path.
func (n *routerNode) getValue(path string) (handle HandleFuncGroup, p Params, tsr bool) {
