...
type routerNode struct {
	...
	indices   string
	children  []*routerNode
	handle    handleFuncNodeGroup
}

// increments priority of the given child and reorders if necessary
func (n *routerNode) incrementChildPrio(pos int) int {
...
func (n *routerNode) addRoute(path string, handle handleFuncNodeGroup) {
	n.fullPath = path
	n.priority++
...
func (n *routerNode) insertChild(numParams uint8, path, fullPath string, handle handleFuncNodeGroup) {
...
// given path.
func (n *routerNode) getValue(path string) (handle handleFuncNodeGroup, p Params, tsr bool) {
...
// was successful.
func (n *routerNode) findCaseInsensitivePath(path string, fixTrailingSlash bool) (ciPath []byte, found bool) {
...
func (n *routerNode) findCaseInsensitivePathRec(path string, ciPath []byte, rb [4]byte, fixTrailingSlash bool) ([]byte, bool) {
	npLen := len(n.path)
